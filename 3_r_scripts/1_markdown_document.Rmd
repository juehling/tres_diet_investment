...
```{r, echo = FALSE}
# Relative abundance
q1_cap1_ra <- ggplot(aquatic_ad_cap1, aes(x=percent_aquatic_ra, y=mass, color=num_fam))+ geom_point()+scale_color_gradient(low="blue", high="red")+scale_x_continuous("Percent of Diet Containing Aquatic Insects")+scale_y_continuous("Adult Mass (g)")
q1_cap1_ra
...
```{r, echo = FALSE}
# Relative abundance
q1_cap2_ra <- ggplot(aquatic_ad_cap2, aes(x=percent_aquatic_ra, y=mass, color=num_fam))+ geom_point()+scale_color_gradient(low="blue", high="red")+scale_x_continuous("Percent of Diet Containing Aquatic Insects")+scale_y_continuous("Adult Mass (g)")
q1_cap2_ra
...
# Relative abundance
q2_ra <- ggplot(data=filter(aquatic_wild_prov, exp_treat == "CortMovement_Cort" | exp_treat == "CortMovement_Control"))+ geom_boxplot((aes(x=age, y= percent_aquatic_ra, fill= age)))+facet_wrap(~exp_treat)
q2_ra

boxplot(percent_aquatic_ra~age*exp_treat, data = aquatic_wild_prov)
...
## This is my start at looking into beta logistic regression, ignore for now.
# m1 <- gamlss(percent_aquatic_ra ~ age + exp_treat + age:exp_treat + re(random = ~1|site_box_year), family= BEINF, data = aquatic_wild_prov, trace = FALSE)
...
```{r, echo = FALSE}
# Relative abundance
q3_plot <- ggplot(aquatic_prov_comp, aes(x=percent_aquatic_ra, y=percent_aquatic_ra_nestlings_mean, color=exp_treat))+geom_point()+scale_x_continuous("Percent Aquatic Adult (relative abundance)")+scale_y_continuous("Percent Aquatic Nest (relative abundance)")
q3_plot
