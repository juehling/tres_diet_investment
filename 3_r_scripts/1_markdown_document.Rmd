...
```{r, echo = FALSE}
# Relative abundance
q1_cap1_ra <- ggplot(aquatic_ad_cap1, aes(x=percent_aquatic_ra, y=mass, color=TotalReads))+ geom_point()+scale_color_gradient(low="blue", high="red")+scale_x_continuous("Percent of Diet Containing Aquatic Insects")+scale_y_continuous("Adult Mass (g)")
q1_cap1_ra
...
```{r, echo = FALSE}
# Relative abundance
q1_cap2_ra <- ggplot(aquatic_ad_cap2, aes(x=percent_aquatic_ra, y=mass, color=TotalReads))+ geom_point()+scale_color_gradient(low="blue", high="red")+scale_x_continuous("Percent of Diet Containing Aquatic Insects")+scale_y_continuous("Adult Mass (g)")
q1_cap2_ra
